      ...
      >
        ...
        <div className='uizz-layout-box-border uizz-layout-h-[calc(100%-var(--eduzz-ui-layout-topbar-height-rem)-14px)] uizz-layout-overflow-y-auto'>
          ...
          {applicationsCategories?.map(category => (
            <section
              className='uizz-layout-mb-4 uizz-layout-grid uizz-layout-grid-cols-1 uizz-layout-flex-wrap uizz-layout-justify-items-center uizz-layout-gap-0 uizz-layout-p-0 uizz-layout-px-4 sm:uizz-layout-mb-2 sm:uizz-layout-grid-cols-2 sm:uizz-layout-gap-6 sm:uizz-layout-p-6 lg:uizz-layout-grid-cols-3 xl:uizz-layout-grid-cols-4'
              key={category.title}
            >
              <header className='uizz-layout-col-span-1 uizz-layout-w-full uizz-layout-py-4 sm:uizz-layout-col-span-2 sm:uizz-layout-p-0 lg:uizz-layout-col-span-3 xl:uizz-layout-col-span-4'>
                <h5 className='!uizz-layout-mb-1 !uizz-layout-mt-0 uizz-layout-w-full uizz-layout-text-base uizz-layout-font-normal uizz-layout-text-content-title'>
                  {category.title}
                </h5>
                ...
                return (
                  <a
                    ...
                    className={cn(
                      ...
                      isCurrent &&
                        '!uizz-layout-bg-content-title/[0.03] dark:!uizz-layout-bg-content-title/[0.06] max-sm:before:uizz-layout-bg-content-title/[0.03] max-sm:after:uizz-layout-bg-content-title/[0.03] dark:max-sm:before:uizz-layout-bg-content-title/[0.06] dark:max-sm:after:uizz-layout-bg-content-title/[0.06]'
                    )}
                    key={app.application}
                  ...
                  >
                    <img
                      src={app.icon}
                      className='uizz-layout-mb-2 uizz-layout-block uizz-layout-max-h-6 uizz-layout-max-w-6'
                    />
                    ...
                    <p className='uizz-layout-col-span-2 uizz-layout-m-0 !uizz-layout-mb-0 uizz-layout-mt-0 uizz-layout-block uizz-layout-overflow-hidden uizz-layout-text-base uizz-layout-leading-normal uizz-layout-text-content-subtitle uizz-layout-opacity-80 sm:uizz-layout-col-span-1 sm:uizz-layout-col-start-2'>
                      {app.description}
                    </p>
                  </a>
                );
